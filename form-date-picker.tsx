...
export interface FormDatePickerProps extends Omit<AriaDatePickerProps<DateValue>, 'children' | 'onChange'> {
...
export const FormDatePicker = forwardRef<HTMLDivElement, FormDatePickerProps>(
  (
    ...
    const describedBy = [
      error ? `${datePickerProps.id || 'datepicker'}-error` : '',
      description ? `${datePickerProps.id || 'datepicker'}-description` : '',
      ariaDescribedBy
    ...
    return (
      ...
      >
        ...
        {description && !hasError && (
          <p
            id={`${datePickerProps.id || 'datepicker'}-description`}
        ...
        {error && (
          <p
            id={`${datePickerProps.id || 'datepicker'}-error`}
...
// Utility functions for Date/DateValue conversion
import { CalendarDate } from "@internationalized/date"

export const dateToCalendarDate = (date: Date | undefined | null): CalendarDate | undefined => {
...
export const calendarDateToDate = (calendarDate: CalendarDate | null): Date | undefined => {
