...
interface PartnershipsTabContentProps {
  articles: Article[];
  loading: boolean;
}

const PartnershipsTabContent = ({ articles, loading }: PartnershipsTabContentProps) => {
...
return (
  ...
  <div className="py-2">
   <FilterSection title="Partnership & Affiliations" />
...
export default PartnershipsTabContent; 